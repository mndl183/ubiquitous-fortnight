#!/usr/bin/env python3
"""
STL Upload to yoimagine Tools Server API

Usage:
    python upload_stl_example.py model.stl --name "My Model" --desc "Description" --tags "tag1,tag2" --meta '{"key": "value"}'
"""
...
API_URL = os.environ.get("STL_API_URL", "https://tools.yoimagine.com/api/upload-stl")
...
def list_models(api_url: str = API_URL) -> list:
...
def delete_model(model_id: str, api_url: str = API_URL) -> dict:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--url", default=API_URL, help="API endpoint")
